...
Used by both Ollama (via bot.llm.ollama_service) and OpenAI/OpenRouter (via Discord handlers).
Config references tools by name, e.g. tools: ["web_search", "web_fetch", "visuals_core"].
"""

from typing import Any, List

from .web_search import WEB_SEARCH_SCHEMA, WEB_FETCH_SCHEMA
from .visuals_core import VISUALS_CORE_SCHEMA
